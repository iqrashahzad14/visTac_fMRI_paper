...
scatter(repmat(x(1,1), length(anat_rMst), 1),data_density(:),sz,shape, 'MarkerEdgeColor',lightGreen,'MarkerEdgeAlpha',Transparency,'LineWidth',LineWidthMarkers,'jitter','on', 'jitterAmount', jitterAmount);
[data_density,sizeN]=compute_density(ext_rMst,density_distance, starting_size);
scatter(repmat(x(2,1), length(ext_rMst), 1),data_density(:),sz,shape, 'MarkerEdgeColor',darkGreen,'MarkerEdgeAlpha',Transparency,'LineWidth',LineWidthMarkers,'jitter','on', 'jitterAmount', jitterAmount);

[data_density,sizeN]=compute_density(anat_rMt,density_distance, starting_size);
scatter(repmat(x(1,2), length(anat_rMt), 1),data_density(:),sz,shape, 'MarkerEdgeColor',lightGreen,'MarkerEdgeAlpha',Transparency,'LineWidth',LineWidthMarkers,'jitter','on', 'jitterAmount', jitterAmount);
[data_density,sizeN]=compute_density(ext_rMt,density_distance, starting_size);
scatter(repmat(x(2,2), length(ext_rMt), 1),data_density(:),sz,shape, 'MarkerEdgeColor',darkGreen,'MarkerEdgeAlpha',Transparency,'LineWidth',LineWidthMarkers,'jitter','on', 'jitterAmount', jitterAmount);
...
% Plot the errorbars
e = errorbar(x',model_series,model_error,'color','k','linestyle','none','LineWidth',LineWidthMean/2);
e(1).Color = 'k';%lightGreen;
e(2).Color = 'k';%darkGreen;
%
...
figureName=strcat('mtMst_anatExt','_PseudoRun','.tif');
