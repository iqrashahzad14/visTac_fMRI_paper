function info = step1RunSearchlightProprioception(opt)
  ...
  for iSub = 1:numel(opt.subjects)
    ...
    for iImage = 1:length(opt.mvpa.map4D)
        ...
        for iDecodingCondition=3%:length(decodingConditionList) %see the types in decoding conditionlist and the filename
