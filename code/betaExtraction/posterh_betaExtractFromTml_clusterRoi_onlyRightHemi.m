...
betaVal = [betaEstMotion4, betaEstStatic4,...
    betaEstMotion5, betaEstStatic5,betaEstMotion6, betaEstStatic6];
...
scatter(repmat(x(1,1), length(betaEstMotion4), 1),betaEstMotion4,sz,shape,'MarkerEdgeColor','k','MarkerFaceColor','k');
scatter(repmat(x(2,1), length(betaEstStatic4), 1),betaEstStatic4,sz,shape,'MarkerEdgeColor','k','MarkerFaceColor','k');

scatter(repmat(x(1,2), length(betaEstMotion5), 1),betaEstMotion5,sz,shape,'MarkerEdgeColor','k','MarkerFaceColor','k');
scatter(repmat(x(2,2), length(betaEstStatic5), 1),betaEstStatic5,sz,shape,'MarkerEdgeColor','k','MarkerFaceColor','k');

scatter(repmat(x(1,3), length(betaEstMotion6), 1),betaEstMotion6,sz,shape,'MarkerEdgeColor','k','MarkerFaceColor','k');
scatter(repmat(x(2,3), length(betaEstStatic6), 1),betaEstStatic6,sz,shape,'MarkerEdgeColor','k','MarkerFaceColor','k');

% Plot connected lines
for iiSub=1:length(subjectList)
    hold on 
    plot([x(1,1), x(2,1)],[betaEstMotion4(iiSub), betaEstStatic4(iiSub)],'k')
    hold on 
    plot([x(1,2), x(2,2)],[betaEstMotion5(iiSub), betaEstStatic5(iiSub)],'k') 
    hold on 
    plot([x(1,3), x(2,3)],[betaEstMotion6(iiSub), betaEstStatic6(iiSub)],'k')  
    hold on 
...
xticklabels({'rMst','rMT','rhMT'})%'lMst','lMT','lhMT',
