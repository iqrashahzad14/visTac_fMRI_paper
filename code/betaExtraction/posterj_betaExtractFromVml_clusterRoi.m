...
b(2).EdgeColor = 'w';%lightOrange;

b(1).CData(1,:) = 'w';%darkOrange;%'w';%Colors(2,:); % group 1 1st bar
b(1).CData(2,:) = 'w';%darkOrange;%'w';%Colors(2,:); % group 1 2nd bar
b(1).CData(3,:) = 'w';%darkOrange;%'w';%Colors(2,:); % group 1 3rd bar
b(1).CData(4,:) = 'w';%darkOrange;%'w';%Colors(2,:); % group 1
b(1).CData(5,:) = 'w';%darkOrange;%'w';%Colors(2,:); % group 1
b(1).CData(6,:) = 'w';%darkOrange;%'w';%Colors(2,:); % group 1
...
scatter(x(1,:),model_series(:,1),600,'_',...
        'MarkerEdgeColor',darkOrange,'MarkerFaceColor',lightGreen,'LineWidth',LineWidthMean )
hold on
scatter(x(2,:),model_series(:,2),600,'_',...
    'MarkerEdgeColor',lightOrange,'MarkerFaceColor',darkGreen,'LineWidth',LineWidthMean )
...
figureName=strcat('mtMst_visBeta','.tif');
