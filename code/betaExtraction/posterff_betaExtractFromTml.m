...
model_series = [mean(betaEstMotion6), mean(betaEstStatic6);...
    mean(betaEstMotion7), mean(betaEstStatic7)];

model_error = [std(betaEstMotion6)/sqrt(length(betaEstMotion6)), std(betaEstStatic6)/sqrt(length(betaEstStatic6));...
...
% % % 
% % scatter(repmat(x(1,1), length(betaEstMotion6), 1),betaEstMotion6,sz,'MarkerEdgeColor','k','MarkerFaceColor','k');
% % scatter(repmat(x(2,1), length(betaEstStatic6), 1),betaEstStatic6,sz,'MarkerEdgeColor','k','MarkerFaceColor','k');
% % 
% % scatter(repmat(x(1,2), length(betaEstMotion7), 1),betaEstMotion7,sz,'MarkerEdgeColor','k','MarkerFaceColor','k');
% % scatter(repmat(x(2,2), length(betaEstStatic7), 1),betaEstStatic7,sz,'MarkerEdgeColor','k','MarkerFaceColor','k');
% % 
...
% % %     hold on 
% %     plot([x(1,1), x(2,1)],[betaEstMotion6(iiSub), betaEstStatic6(iiSub)],'k')
% %     hold on 
% %     plot([x(1,2), x(2,2)],[betaEstMotion7(iiSub), betaEstStatic7(iiSub)],'k')
% % end
