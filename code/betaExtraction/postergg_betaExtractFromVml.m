...
b(1).CData(2,:) = darkOrange;%'w';%Colors(2,:); % group 1
b(1).CData(3,:) = darkOrange;%'w';%Colors(2,:); % group 1
...
b(2).CData(2,:) = lightOrange;%'w';%Colors(4,:); % group 2 
b(2).CData(3,:) = lightOrange;%'w';%Colors(4,:); % group 2 
...
% % 
% % scatter(repmat(x(1,2), length(betaEstMotion4), 1),betaEstMotion4,sz,'MarkerEdgeColor','k','MarkerFaceColor','k');
% % scatter(repmat(x(2,2), length(betaEstStatic4), 1),betaEstStatic4,sz,'MarkerEdgeColor','k','MarkerFaceColor','k');
% % 
% % scatter(repmat(x(1,3), length(betaEstMotion5), 1),betaEstMotion5,sz,'MarkerEdgeColor','k','MarkerFaceColor','k');
% % scatter(repmat(x(2,3), length(betaEstStatic5), 1),betaEstStatic5,sz,'MarkerEdgeColor','k','MarkerFaceColor','k');
% % 
...
% %     hold on 
% %     plot([x(1,2), x(2,2)],[betaEstMotion4(iiSub), betaEstStatic4(iiSub)],'k')
% %     hold on 
% %     plot([x(1,3), x(2,3)],[betaEstMotion5(iiSub), betaEstStatic5(iiSub)],'k')    
% %     hold on 
...
data = [betaEstMotion1, betaEstStatic1;... 
    betaEstMotion4, betaEstStatic4;...
...
% paired ttest
[hA,pA] = ttest(betaEstMotion1,betaEstStatic1) % n.s. p=0.6375
[hB,pB] = ttest(betaEstMotion4,betaEstStatic4) % s. p =4.6954e-04
[hC,pC] = ttest(betaEstMotion5,betaEstStatic5) % s. p = 3.3740e-05
