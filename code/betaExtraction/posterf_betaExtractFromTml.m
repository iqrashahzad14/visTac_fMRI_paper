...
b = bar(model_series, 'grouped','FaceColor','flat', 'LineWidth',LineWidthMean/2,'BarWidth', 0.5 );
...
scatter(x(1,:),model_series(:,1),600,'_',...
        'MarkerEdgeColor',darkGreen,'MarkerFaceColor',lightGreen,'LineWidth',LineWidthMean/4 )
hold on
scatter(x(2,:),model_series(:,2),600,'_',...
    'MarkerEdgeColor',lightGreen,'MarkerFaceColor',darkGreen,'LineWidth',LineWidthMean/4 )
...
for iiSub=1:17%length(subjectList)
    hold on 
...
figureName=strcat('tacBeta','_lS1_SphericalRoi','.tif');
