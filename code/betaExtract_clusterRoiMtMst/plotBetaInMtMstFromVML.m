...
b(1).CData(1,:) = darkOrange;% % group 1 1st bar
b(1).CData(2,:) = darkOrange;% % group 1 2nd bar
b(1).CData(3,:) = darkOrange;% % 
b(1).CData(4,:) = darkOrange;% % 
b(1).CData(5,:) = darkOrange;% % 
b(1).CData(6,:) = darkOrange;% % 

b(2).CData(1,:) = lightOrange;% % group 2 1st bar
b(2).CData(2,:) = lightOrange;% % group 2 2nd bar
b(2).CData(3,:) = lightOrange;% % 
b(2).CData(4,:) = lightOrange;% % 
b(2).CData(5,:) = lightOrange;% % 
b(2).CData(6,:) = lightOrange;% % 
