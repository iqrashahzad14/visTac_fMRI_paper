...
%% extract beta estimates from TML task 
clear
...
for iSub = 1:length(subjectList)
    ...
    %where is the glm
%     glmDir = strcat('/Users/shahzad/Files/fMRI/visTac/fMRI_analysis/outputs/derivatives/bidspm-stats/',char(subID),strcat('/task-',taskName,'_space-IXI549Space_FWHM-0'));
...
%     });
%  
% writetable(T,'betaFromMstFromTML.xlsx')