...
[data_density,sizeN]=compute_density(visDir_lhMT,density_distance, starting_size);
scatter(repmat(x(1,4), length(visDir_lhMT), 1),data_density(:),sz,shape,'MarkerEdgeColor',darkOrange,'MarkerEdgeAlpha',Transparency,'LineWidth',LineWidthMarkers,'jitter','on', 'jitterAmount', jitterAmount);

[data_density,sizeN]=compute_density(visDir_rhMT,density_distance, starting_size);
scatter(repmat(x(1,5), length(visDir_rhMT), 1),data_density(:),sz,shape,'MarkerEdgeColor',darkOrange,'MarkerEdgeAlpha',Transparency,'LineWidth',LineWidthMarkers,'jitter','on', 'jitterAmount', jitterAmount);
...
figureName=strcat('visDir','_PseudoRun','.tif');
...
%%
% da = [visDir_lS1, visDir_lMTt, visDir_rMTt, visDir_lhMT, visDir_rhMT];
% T=array2table(da,...
%     'VariableNames',{'lS1', 'lMTt', 'rMTt', 'lhMT', 'rhMT'});
% 
