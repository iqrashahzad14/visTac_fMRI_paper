...
scatter(repmat(x(1,4),length(both_lhMT),1), data_density(:),sz, shape,'MarkerEdgeColor',darkGrey,'MarkerEdgeAlpha',Transparency,'LineWidth',LineWidthMarkers,'jitter','on', 'jitterAmount', jitterAmount);

[data_density,sizeN]=compute_density(both_rhMT,density_distance, starting_size);
scatter(repmat(x(1,5),length(both_rhMT),1), data_density(:),sz, shape,'MarkerEdgeColor',darkGrey,'MarkerEdgeAlpha',Transparency,'LineWidth',LineWidthMarkers,'jitter','on', 'jitterAmount', jitterAmount);
...
figureName=strcat('crossModExt_',crossModType,'_PseudoRun','.tif');
...
%%
% da_both=[both_lS1, both_lMTt, both_rMTt, both_lhMT, both_rhMT];
% T_both=array2table(da_both,...
%     'VariableNames',{'lS1', 'lMTt', 'rMTt', 'lhMT', 'rhMT'});
% 
% da_trainVis=[trainVis_lS1, trainVis_lMTt, trainVis_rMTt, trainVis_lhMT, trainVis_rhMT];
% T_trainVis=array2table(da_trainVis,...
%     'VariableNames',{'lS1', 'lMTt', 'rMTt', 'lhMT', 'rhMT'});
% 
% da_trainTac=[trainTac_lS1, trainTac_lMTt, trainTac_rMTt, trainTac_lhMT, trainTac_rhMT];
