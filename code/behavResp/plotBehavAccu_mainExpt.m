...
%to plot the main decoding experiments
a=tab.visVer(1:20); b= tab.visHor(1:20);
c=tab.huPt(1:20); d=tab.huFw(1:20);
e=tab.hdPt(1:20); f=tab.hdFw(1:20);
...
xticklabels({'Visual','Hand Up', 'Hand Down'})
